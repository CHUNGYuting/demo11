...
public class Bird extends Animal {
	...
	// bird 的 name 和 age 繼承父類別Animal，所以帶有 name 和 age 的建構方法會去呼叫父類別的建構方法
	...
	// 2. @Override 就是用來標記子類別重新定義父類別的方法:目前的Java版本，此註釋可省略，建議加
	// 2.1 @ 是 Annotation，註釋:會在程式碼中提供訊息，這些訊息會在編譯或是執行時被處理
	// 3.子類別重新定義的方法:
	// 3.1 權限不可比父類別小
	// 3.2 回傳的資料型態要一樣
	// 3.3 方法名稱和小括號中的參數數量都要一樣
	@Override
	public void eat() {
